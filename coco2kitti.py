...
if __name__ == '__main__':
    ...
    dataDir = '/home/getter-lab/Vídeos/new_dataset/'#..
    dataType = 'more-imgs'
    annFile = f'{dataDir}/{dataType}/coco_dataset/labels.json'
    ...
    if os.path.isdir('./labels_more-imgs'):
        ...
        os.mkdir('./home/getter-lab/Vídeos/new_dataset/labels_more-imgs')
